...
namespace NBrigadier
{
    ...
    public class CommandDispatcher<TS>
    {
        ...
        ///     <para>
        ///         This is often useful as a target of a
        ///         <seealso cref="com.mojang.brigadier.builder.ArgumentBuilder.redirect(CommandNode)" />,
        ///         <seealso cref="getAllUsage(CommandNode, object, bool)" /> or
        ///         <seealso cref="getSmartUsage(CommandNode, object)" />.
        ///         You may also use it to clone the command tree via <seealso cref="CommandDispatcher(RootCommandNode)" />.
        ///     </para>
        /// </summary>
        ...
        ///     <para>
        ///         This is a shortcut for calling <seealso cref="RootCommandNode.addChild(CommandNode)" /> after building the
        ///         provided {@code command}.
        ///     </para>
        ...
        ///     <para>
        ///         This is a shortcut to first <seealso cref="parse(StringReader, object)" /> and then
        ///         <seealso cref="execute(ParseResults)" />.
        ///     </para>
        ///     <para>
        ///         It is recommended to parse and execute as separate steps, as parsing is often the most expensive step, and
        ///         easiest to cache.
        ///     </para>
        ///     <para>
        ///         If this command returns a value, then it successfully executed something. If it could not parse the command, or
        ///         the execution was a failure,
        ///         then an exception will be thrown. Most exceptions will be of type <seealso cref="CommandSyntaxException" />,
        ///         but it is possible that a <seealso cref="System.Exception" />
        ///         may bubble up from the result of a command. The meaning behind the returned result is arbitrary, and will
        ///         depend
        ///         entirely on what command was performed.
        ///     </para>
        ///     <para>
        ///         If the command passes through a node that is <seealso cref="CommandNode.isFork()" /> then it will be 'forked'.
        ///         A forked command will not bubble up any <seealso cref="CommandSyntaxException" />s, and the 'result' returned
        ///         will turn into
        ///         'amount of successful commands executes'.
        ///     </para>
        ///     <para>
        ///         After each and any command is ran, a registered callback given to
        ///         <seealso cref="setConsumer(ResultConsumer)" />
        ...
        /// <seealso cref= # parse( String, Object
        /// )
        /// </seealso>
        /// <seealso cref= # parse( StringReader, Object
        /// )
        /// </seealso>
        /// <seealso cref= # execute( ParseResults
        /// )
        ...
        ///         Most exceptions will be of type <seealso cref="CommandSyntaxException" />, but it is possible that a
        ...
        ///     </para>
        ///     <para>
        ///         If the command passes through a node that is <seealso cref="CommandNode.isFork()" /> then the resulting context
        ///         will be marked as 'forked'.
        ///         Forked contexts may contain child contexts, which may be modified by the <seealso cref="RedirectModifier" />
        ///         attached to the fork.
        ///     </para>
        ///     <para>
        ///         Parsing a command can never fail, you will always be provided with a new <seealso cref="ParseResults" />.
        ///         However, that does not mean that it will always parse into a valid command. You should inspect the returned
        ///         results
        ///         to check for validity. If its <seealso cref="ParseResults.getReader()" />
        ///         <seealso cref="StringReader.canRead()" /> then it did not finish
        ///         parsing successfully. You can use that position as an indicator to the user where the command stopped being
        ///         valid.
        ///         You may inspect <seealso cref="ParseResults.getExceptions()" /> if you know the parse failed, as it will
        ///         explain why it could
        ///         not find any valid commands. It may contain multiple exceptions, one for each "potential node" that it could
        ///         have visited,
        ///         explaining why it did not go down that node.
        ///     </para>
        ///     <para>
        ///         When you eventually call <seealso cref="execute(ParseResults)" /> with the result of this method, the above
        ///         error checking
        ...
        ///     <para>
        ///         The returned syntax will be in "simple" form: {@code
        ///         <param>
        ///             } and {@code literal}. "Optional" nodes will be
        ...
        ///     </ul>
        ///     <para>
        ///         The path to the specified node will <b>not</b> be prepended to the output, as there can theoretically be many
        ...
        ///     <para>
        ///         The returned syntax will be in "smart" form: {@code
        ///         <param>
        ///             }, {@code literal}, {@code [optional]} and {@code (either|or)}.
        ///             These forms may be mixed and matched to provide as much information about the child nodes as it can,
        ///             without being too verbose.
        ///             For example, a required literal "foo" followed by an optional param "int" can be compressed into one
        ///             string:
        ///     </para>
        ///     <ul>
        ///         <li>{@code foo [<int>]}</li>
        ...
        ///     <para>
        ///         There may theoretically be multiple paths to a node on the tree, especially with the use of forking or
        ///         redirecting.
        ...
        ///         this method will <b>always</b> be a valid input for <seealso cref="findNode(System.Collections.ICollection)" />
        ///         , which should return the same node
        ...
        ///     <para>
        ///         Paths may be generated with <seealso cref="getPath(CommandNode)" />, and are guaranteed (for the same tree, and
        ///         the
        ...
        ///     <para>
        ///         This is a shortcut for <seealso cref="CommandNode.findAmbiguities(AmbiguityConsumer)" /> on
        ///         <seealso cref="getRoot()" />.
        ///     </para>
        ///     <para>
        ///         Ambiguities are detected by testing every <seealso cref="CommandNode.getExamples()" /> on one node verses every
        ///         sibling
        ///         node. This is not fool proof, and relies a lot on the providers of the used argument types to give good
        ///         examples.
        ///     </para>
        /// </summary>
